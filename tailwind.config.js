  	...
  	extend: {
  		...
  		keyframes: {
  			...
  			'glitch': {
  				...
  				'1%': { opacity: '0', filter: 'brightness(0)' },
  				'3%': { opacity: '1', filter: 'brightness(1)' },
  				'3.5%': { opacity: '0', filter: 'brightness(0)' },
  				'6.5%': { opacity: '1', filter: 'brightness(1.5)' },
  				'8%': { opacity: '1', filter: 'brightness(5)' },
  				'12%': { opacity: '0', filter: 'brightness(0)' },
  				'12.8%': { opacity: '1', filter: 'brightness(2)' },
  				'16%': { opacity: '0.15', filter: 'brightness(0.5)' },
  				'50%': { opacity: '0', filter: 'brightness(0)' },
  				'85%': { opacity: '0', filter: 'brightness(0)' },
  				'86.3%': { opacity: '0.8', filter: 'brightness(1.5)' },
  				'87.7%': { opacity: '0', filter: 'brightness(0)' },
  				'91%': { opacity: '0.4', filter: 'brightness(0.7)' },
  				'93.6%': { opacity: '0', filter: 'brightness(0)' },
  				'98.1%': { opacity: '1', filter: 'brightness(2.5)' },
